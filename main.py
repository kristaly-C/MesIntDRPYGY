...
class App(customtkinter.CTk):
    ...
    def __init__(self):
        ...
        self.lab1 = customtkinter.CTkLabel(self.futar_frame, text="Number of couriers:", font=customtkinter.CTkFont(size=20, weight="bold"))
        self.lab1.grid(row=0, column=0, padx=10, sticky="ew")
        ...
        self.lab5 = customtkinter.CTkLabel(self.cycle_frame, text="Number of cycles:", font=customtkinter.CTkFont(size=20, weight="bold"))
